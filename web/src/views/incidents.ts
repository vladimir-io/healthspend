    ...
    container.innerHTML = `
        <div class="hero-section animate-up" style="--stagger:1;">
            <div class="status-pill-container">
                ...
                <span style="color:var(--text-secondary);">7,400+ Federal Nodes Monitored</span>
            </div>
            <h1 class="hero-headline">Incident Log</h1>
            <p class="hero-sub">Realtime monitoring of federal price transparency violations <br /> clinical index of 7,400+ hospitals failing to meet the CY ${new Date().getFullYear()} mandate.</p>
        </div>
            ...
            results.forEach((record: ComplianceRecord) => {
                ...
                row.innerHTML = `
                    ...
                    <div style="text-align:right;display:flex;flex-direction:column;gap:8px;align-items:flex-end;">
                        <button class="btn secondary btn-report" style="font-size:0.72rem; padding:6px 14px; border-color:var(--yc-orange); color:var(--yc-orange);">File Complaint</button>
